...
function checkUpdates()
    ...
    lua_thread.create(function()
        ...
        local json_url = "https://raw.githubusercontent.com/ТВОЙ_НИК/ТВОЙ_РЕПОЗИТОРИЙ/main/update.json"
            ...
            if response and response.status_code == 200 then
                ...
                if ok and updateInfo then
                    ...
                    if new_version ~= current_version then
                        sampAddChatMessage('[Arizona Helper] {ffffff}Найдено обновление! Новая версия: {009EFF}'..new_version, 40703)
                        sampAddChatMessage('[Arizona Helper] {ffffff}Начинаю скачивание...', 40703)
                        ...
                        sampAddChatMessage('[Arizona Helper] {ffffff}Скрипт успешно обновлен! Перезагрузите Lua.', 40703)
